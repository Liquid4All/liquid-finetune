...
contract during Q4_0/Q8_0 export. The exporter stages quantized formats through
F32 so FP32 QAT updates reach llama.cpp unchanged; the temporary F32 GGUF is
removed after quantization.
