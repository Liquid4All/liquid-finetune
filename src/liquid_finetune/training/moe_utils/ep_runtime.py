...
from liquid_finetune.training.moe_utils.memory_trace import write_memory_trace_event
...
from liquid_finetune.training.moe_utils.ops import (
    grouped_mm,
    permute_tokens,
...
_MEM_DEBUG_ENABLED = os.getenv("LIQUID_MOE_MEM_DEBUG", "").lower() in {
    "1",
    "true",
    "yes",
}
_MEM_SUMMARY_ENABLED = os.getenv("LIQUID_MOE_MEM_SUMMARY", "").lower() in {
    "1",
    "true",
    "yes",
}
_STAGE_TRACE_ENABLED = os.getenv("LIQUID_STAGE_TRACE", "").lower() in {
    "1",
    "true",
    "yes",
}
_A2A_TRACE_ENABLED = os.getenv("LIQUID_EP_A2A_TRACE", "").lower() in {
    "1",
    "true",
    "yes",
}
